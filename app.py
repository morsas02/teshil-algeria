...
def init_db():
    ...
    seed_employers = [
        ...
        ('Djezzy', 'شركة جيزي للاتصالات', 'بئر مراد رايس', 'الجزائر', 'الاتصالات', '1000-5000', 36.7420, 3.0100),
        ('Ooredoo', 'شركة أوريدو للاتصالات', 'حاسي مسعود', 'الوادي', 'الاتصالات', '1000-5000', 33.0667, 6.8333),
        ('Air Algerie', 'الخطوط الجوية الجزائرية', 'المطار الجديد', 'الجزائر', 'النقل والطيران', '5000-10000', 36.6910, 3.2154),
        ('Banque Algeérie', 'البنك العام الجزائري', 'الجزائر العاصمة', 'الجزائر', 'المصرفية', '10000+', 36.7525, 3.0580),
        ...
        ('Groupe Sim', 'شركة سيم للتجارة', 'وهران', 'وهران', 'التجارة والتوزيع', '1000-5000', 35.6892, -0.6309),
        ('Raoued Logistics', 'شركة رائد للخدمات اللوجستية', 'قسنطينة', 'قسنطينة', 'اللوجستيات والشحن', '500-1000', 36.3650, 6.6147),
        ('Algerie Telecom', 'الاتصالات الجزائرية', 'الجزائر العاصمة', 'الجزائر', 'الاتصالات', '10000+', 36.7500, 3.0600),
    ]
